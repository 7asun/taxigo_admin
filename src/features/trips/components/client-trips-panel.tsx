...
export function ClientTripsPanel({
  ...
  React.useEffect(() => {
    ...
    const fetchTrips = async () => {
      ...
      const selectFields =
        'id, scheduled_at, pickup_address, dropoff_address, status, is_wheelchair, group_id, client_name, rule_id, client_id, billing_variant:billing_variants(name, code, billing_types(name, color)), driver:accounts!trips_driver_id_fkey(name)';
