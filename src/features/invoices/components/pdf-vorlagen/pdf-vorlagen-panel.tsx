...
/**
 * pdf-vorlagen-panel.tsx
 *
 * Left list: PDF Vorlagen with search and “+ Neue Vorlage”. Uses PanelList;
 * data is passed from the parent (React Query).
 */
...
interface PdfVorlagenPanelProps {
  items: PdfVorlageRow[];
  loading?: boolean;
  selectedId: string | null;
  onSelect: (row: PdfVorlageRow) => void;
  onNew: () => void;
  className?: string;
}

export function PdfVorlagenPanel({
  items,
  loading = false,
  selectedId,
  onSelect,
