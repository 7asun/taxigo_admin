...
| `date = 25.03.2026`, `time = ` _(empty)_ | `null`                | `2026-03-25`     | **Appears** — date picker pre-filled    |
| `date = ` _(missing/invalid)_            | —                     | —                | Row **rejected** (`invalid_datetime`)   |
...
| `create_placeholder` _(old value)_ | → normalised to `time_tbd` |          |
